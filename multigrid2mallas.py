...
def multigrid2mallas(n,f,k,x0,E,norma): #n:num subinterv PAR,k:num iteraciones previas
    h = np.pi/n
    malla = []
    fh = []
    for j in range(1,n):
...
result1 = multigrid2mallas(8,f,2000,x01,10**(-7),np.inf)
result2 = multigrid2mallas(16,f,2000,x02,10**(-7),np.inf)
result3 = multigrid2mallas(32,f,3000,x03,10**(-7),np.inf)
